...
import { ResponsiveImageSlider } from "../../Component/ResponsiveImageSlider/ResponsiveImageSlider";
...
export function ProgramPage() {
    ...
    useEffect(() => {
        let isMounted = true;
        const basePath = `/Data/Festival/${year}/Program`;
        ...
        const getExistingImageUrl = async (photoNumber) => {
            ...
            for (const extension of extensions) {
                const url = `${basePath}/photo${photoNumber}.${extension}`;
        ...
        const loadImages = async () => {
            const photoCount = yearsPhotoCount[year];

            if (photoCount) {
                const yearsPhoto = [];
                for (let i = 1; i <= photoCount; i++)
                    yearsPhoto.push({ url: `${basePath}/photo${i}.jpg` });
            ...
            const yearsPhoto = [];
            for (let i = 1; i <= 200; i++) {
                const url = await getExistingImageUrl(i);
    ...
    return (
        <div className="programPage">
            ...
            <div className="programPage__container">
                <div className="programPage__informationBlock">
                    <div className="heading">
                        ...
                        <h1 className="programPage__container__info">Гульнявая забаўляная праграма</h1>
                    </div>
