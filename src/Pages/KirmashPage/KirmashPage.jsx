// Купальскi кiрмаш “Александрыя збiрае сяброў“
...
export function KirmashPage() {
    ...
    useEffect(() => {
        ...
        for (let i = 1; i <= yearsPhotoCount[year]; i++)
            yearsPhoto.push({ url: `/Data/Festival/` + year + `/Kirmash/photo` + i + `.jpg` });
    ...
    return (
        <div className="kirmashPage">
            ...
            <div className="kirmashPage__container">
                <div className="kirmashPage__informationBlock">
                    <div className="heading">
                        ...
                        <h1 className="kirmashPage__container__info">Купальскi кiрмаш “Александрыя збiрае сяброў“</h1>
                    </div>
